...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200717_diax_d04d335b635077dc2350_20210316092435_archive.zip';
	const ARCHIVE_SIZE		 = '61423942';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd04d335-16092435';
    const SECONDARY_PACKAGE_HASH = '2be4943-16092435';
	const VERSION			 = '1.4.0';
