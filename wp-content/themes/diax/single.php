	...
	<div id="primary" class="content-area">
		...
		<aside class="diensten-menu">		
			<ul class="onze-diensten">
                ...
                <li><a href="http://localhost/diax/audits-certificeringstrajecten//">Audits & certificeringstrajecten</a></li>
                <li><a href="http://localhost/diax/adviesverlening-coaching/">Adviesverlening & coaching</a></li>
